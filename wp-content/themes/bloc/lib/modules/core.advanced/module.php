...
function shoestrap_module_advanced_options( $sections ) {
  ...
  $fields[] = array( 
    'title'     => __( 'Excerpt type', 'shoestrap' ),
    'desc'      => __( 'Choose how the excerpts should be displayed on the home page, blog and archive pages.', 'shoestrap' ),
  ...
  $fields[] = array( 
    ...
    'desc'      => __( 'Choose how many words should be used for truncated excerpts.', 'shoestrap' ),
    ...
    'edit'      => 1,
    'type'      => 'slider',
    'required'    => array('post_excerpt_type','=',array('truncated')),       
  ); 
  ...
  $fields[] = array( 
    'title'     => __( 'Smooth scrolling', 'shoestrap' ),
    'desc'      => __( 'Enable smooth scrolling with the mouse.', 'shoestrap' ),
    'id'        => 'ac_smooth_scrolling',
    'default'   => 1,
    'type'      => 'switch',
  );    

  $fields[] = array( 
    'title'     => __( 'Sticky sidebars for Portfolio pages', 'shoestrap' ),
    'desc'      => __( 'Allow the sidebar on Portfolio pages to stick to the side of the screen.', 'shoestrap' ),
    'id'        => 'ac_sticky_sidebars',
    'default'   => 1,
    'type'      => 'switch',
  );    
