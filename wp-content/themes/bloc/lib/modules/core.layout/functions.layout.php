...
function shoestrap_layout_body_class( $classes ) {
  ...
  // Smooth Scrolling
  $ac_smooth_scrolling = shoestrap_getVariable( 'ac_smooth_scrolling' );
  if ($ac_smooth_scrolling == 1) {
	 $classes[] = ' smooth-scrolling ';
  }

  // Sticky sidebars
  $ac_sticky_sidebars = shoestrap_getVariable( 'ac_sticky_sidebars' );
  if ($ac_sticky_sidebars == 1) {
	 $classes[] = ' ac_sticky_sidebars ';
  }
  
  // Nav type
  $navbar_desktop_type = shoestrap_getVariable( 'navbar_desktop_type' );
	$classes[] = 'navtype-'.$navbar_desktop_type;
