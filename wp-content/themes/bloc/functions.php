...
if (!function_exists('ac_enqueue_scripts')) {
    ...
    wp_enqueue_script('royalslider', AC_INCLUDES_URI . '/royalslider/jquery.royalslider.min.js', array('jquery'), false, true);
		wp_enqueue_script('slick', AC_INCLUDES_URI . '/slick-slide/slick.min.js', array('jquery'));    
...
// The maxium width any images should be when outside of the grid = 1600; // The maxium width any images should be when outside of the grid
...
// Filter to change how many products display on WooCommerce Archive
