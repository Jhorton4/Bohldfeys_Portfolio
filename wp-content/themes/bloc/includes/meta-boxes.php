...
function ac_register_meta_boxes( $meta_boxes )
{
	...
	$slideshow_options = array(
		...
		'ac_carousel' => __( 'Alleycat Carousel', 'alleycat')
	);
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'type'     => 'select',
				'options'  => array(
					'top-images' 					=> __( 'Images at Top - Slideshow', 'alleycat'),
					'top-images-carousel' => __( 'Images at Top - Carousel', 'alleycat'),
			...
			array(
				'name'  => __( 'Client name', 'alleycat'),
				'id'    => "{$prefix}client",
				'desc'  => __( 'Enter the client name', 'alleycat'),
				'type'  => 'text',
				'std'   => '',
			),			
			array(
				'name'  => __( 'Agency name', 'alleycat'),
				'id'    => "{$prefix}agency",
				'desc'  => __( 'Enter the agency name', 'alleycat'),
				'type'  => 'text',
				'std'   => '',
			),			
			array(
			...
			array(
				'name' => __( 'Show what in the Sidebar?', 'alleycat'),
				'id'   => "{$prefix}show_portfolio_sidebar",
				'type'     => 'select',
				'options'  => array(
					'meta' 			=> __( 'Meta data', 'alleycat'),
					'sidebar' 	=> __( 'Portfolio Sidebar widgets', 'alleycat'),
					'both' 			=> __( 'Meta data & Portfolio Sidebar widgets', 'alleycat'),
					'none' 			=> __( 'Nothing', 'alleycat'),
				),
				'std'   => 'meta',				
			),			
			array(
