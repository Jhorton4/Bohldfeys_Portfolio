...
$full_width = true; // Default to true to ensure images are big enough for a full width page.  Can't read the VC row here, which would be ideal.
		...
		<div class='text'>
			...
			<div class="text-inner">
			  ...
			  <?php echo ac_person_get_position(); ?>			
				...
				<?php else : ?>
					<?php if ($show_terms) : ?>
						<div class='ac-tile-footer'><?php echo ac_get_the_term_list($post->ID, $post_category, '', ', ', '', false); ?></div>
					<?php endif; ?>
				<?php endif; ?>		
